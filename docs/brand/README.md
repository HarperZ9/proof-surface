...
- Product role: stdlib-only contracts and validators for evidence packets, receipts, gates, ledgers, and verdicts.
- Tool-specific motif: receipt ledger, packet joins, and verification label.
